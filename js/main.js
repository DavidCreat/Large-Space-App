...
$(window).on('load', function() {
	...
	/* -----------------------------------
			  2. Sound Setup
	----------------------------------- */
	$('body').append('<audio loop autoplay volume="80" id="audio-player"><source src="audio/Do Not Let Your Hearts Be Troubled.mp3" type="audio/mpeg">Do Not Let Your Hearts Be Troubled.mp3</audio>');
